...
- Dependence on proprietary tools: Many organisations in Nigeria defer to the use of tools that add their own layer of complexity to data management without due cognisance being taken of the peculiarities associated with local data sets. <br>
...
This will install the stable version from [CRAN](https://cran.r-project.org/package=naijR). To work with the development version of the package, it can be installed from GitHub with
